			...
			<div id="pie">	  
			  <hr>
			   	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
			   	    <tbody><tr>
			   	      <td>
			          <img src="lib/Confianza/imagenes/estructura/pie.jpg" usemap="#creditos" title"certificado="" co230272"="" border="0" height="80" width="520"></img>
			          <map name="creditos" id="creditos">
						  <area shape="rect" coords="445,25,519,48" href="http://www.confianza.com.co/index.php?seccion=interna&amp;id=11"></area>
					  </map></td>
			   	      <td align="right">CONFIANZA.COM.CO COPYRIGHT©2010 CONFIANZA S.A.<br>Calle 82 No. 11 - 37 (Piso 7) Bogotá Colombia - (57) 1- 6 44 46 90<br>Se prohíbe la reproducción total o parcial de cualquiera de los contenidos, <br>así como su traducción a cualquier idioma sin autorización escrita de su titular.</td>
			          </tr></tbody></table>
			</div>
		</div>
